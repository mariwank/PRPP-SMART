...
### STAN FUNCTIONS/CODE
# load functions for posterior draw corrections to achieve nominal coverage (Williams and Savitsky 2021)
...
# load stan models
mod_dm <- stan_model('bayes_prpp_smart.stan', auto_write = TRUE) # Full WRRM Stan Code
mod_dm_traditional <- stan_model('bayes_prpp_smart_traditional.stan', auto_write = TRUE) # traditional WRRM Stan code
...
theta1_mu <- 0
sigma2 <- 1
sigma <- sqrt(sigma2) # used in all analyses
...
folder_path <- "path to your folder where you want to store Bayesian results"

# Example: 
# folder_path <- paste0("/Users/mariwank/Documents/UMICH/dissertation/WRRM_Paper/SimResults/Bayesian/Scenario", scenario)
